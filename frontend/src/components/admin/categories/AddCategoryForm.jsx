      ...
      >
        ...
        <div className="flex  w-full justify-between items-center absolute bottom-14">
          <button
            ...
            type="button"
            className={`border border-borderColor rounded-[5px] font-metropolis  text-textColor py-[10] px-4 text-sm font-medium`}
          >
            Cancel
          </button>
          <button
            disabled={open}
            type="submit"
            className={`font-metropolis rounded-[5px]  bg-custom-blue bg-blue-800 text-white  py-[10px] px-4 text-sm font-medium`}
          >
